...
$message = $__bag->first($__errorArgs[0]); ?>
        <p class="text-red-500 text-md mt-2"><?php echo e($message); ?></p>
<?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><?php /**PATH /Users/kristianv/SchulerApp/resources/views/components/form/error.blade.php ENDPATH**/ ?>