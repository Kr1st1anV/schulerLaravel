<?php foreach($attributes->onlyProps(['stylesheet' => 'app', 'title']) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
<?php $attributes = $attributes->exceptProps(['stylesheet' => 'app', 'title']); ?>
<?php foreach (array_filter((['stylesheet' => 'app', 'title']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
...
<head>
   ...
   <link rel="stylesheet" href="/css/<?php echo e($stylesheet); ?>.css">
...
</html><?php /**PATH /Users/kristianv/SchulerApp/resources/views/components/layout.blade.php ENDPATH**/ ?>